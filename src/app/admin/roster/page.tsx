...
export default async function RosterPage({
    ...
    return (
        <div className="roster-page-shell" style={{ height: 'calc(100vh - 40px)', display: 'flex', flexDirection: 'column', minHeight: 0, minWidth: 0, overflow: 'hidden', marginBottom: 'var(--roster-bottom-trim, -1.5rem)' }}>
